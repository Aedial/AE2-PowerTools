...
public class ItemNetworkComponentLocator extends Item {
    ...
    public void addInformation(@Nonnull ItemStack stack, World world, @Nonnull List<String> tooltip,
        ...
        tooltip.add("");
        tooltip.add(I18n.format("item.ae2powertools.network_component_locator.tip1"));
        tooltip.add(I18n.format("item.ae2powertools.network_component_locator.tip2"));

        boolean overlayEnabled = isOverlayEnabled(stack);
        String overlayState = I18n.format(overlayEnabled ?
            "item.ae2powertools.network_component_locator.overlay_on" :
            "item.ae2powertools.network_component_locator.overlay_off");
        tooltip.add(I18n.format("item.ae2powertools.network_component_locator.tip3", overlayState));
    }
}
