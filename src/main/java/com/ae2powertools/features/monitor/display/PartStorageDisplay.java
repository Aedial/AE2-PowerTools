 ...
 */
public class PartStorageDisplay extends PartStorageMonitorBase {
    ...
    public void renderDynamic(double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        DisplayRenderHelper.drawScreenCenter(packedLight, facing);
        DisplayRenderHelper.drawCornerIndicators(displayLogic.getCornerColor(), packedLight, facing);
